...
class _CreatePostPageWidgetState extends State<CreatePostPageWidget> {
  ...
  void initState() {
    ...
    _model.postContentTextController ??= TextEditingController();
    _model.postContentFocusNode ??= FocusNode();
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          TextFormField(
                            controller: _model.postContentTextController,
                            focusNode: _model.postContentFocusNode,
                            autofocus: true,
                            ...
                            validator: _model.postContentTextControllerValidator
                                .asValidator(context),
                            inputFormatters: [
                              if (!isAndroid && !isiOS)
                ...
                FlutterFlowIconButton(
                  ...
                  onPressed: () async {
                    ...
                    if (selectedMedia != null &&
                      ...
                      safeSetState(
                          () => _model.isDataUploading_uploadData79u = true);
                      ...
                      try {
                        ...
                        _model.isDataUploading_uploadData79u = false;
                      }
                      if (selectedUploadedFiles.length ==
                              selectedMedia.length &&
                          downloadUrls.length == selectedMedia.length) {
                        safeSetState(() {
                          _model.uploadedLocalFile_uploadData79u =
                              selectedUploadedFiles.first;
                          _model.uploadedFileUrl_uploadData79u =
                              downloadUrls.first;
                        });
                      } else {
                        safeSetState(() {});
                ...
                if (_model.uploadedFileUrl_uploadData79u != null &&
                    _model.uploadedFileUrl_uploadData79u != '')
                  Padding(
                    padding:
                            ...
                            onPressed: () async {
                              ...
                              await PostsRecord.collection
                                  ...
                                  .set(createPostsRecordData(
                                    image: _model.uploadedFileUrl_uploadData79u,
                                    date: getCurrentTimestamp,
                                    text: _model.postContentTextController.text,
